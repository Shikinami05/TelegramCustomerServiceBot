...
正式 Tag 部署会显示例如 `v1.6.0`；开发分支会显示例如 `v1.6.0+提交号`。
...
```bash
bash scripts/create-release.sh v1.6.0
```
...
```json
{"ok":true,"version":"1.6.0","db":"ok","broadcast_worker":"ok"}
```
